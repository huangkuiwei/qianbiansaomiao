...
export function createApp() {
	...
	app.config.globalProperties.$viewUrl = 'https://file.ardila.cn/onlinePreview?url=';
	app.config.globalProperties.$picsUrl = 'https://file.ardila.cn/picturesPreview?urls=';
